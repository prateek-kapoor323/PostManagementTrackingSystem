package com.postManagementTrackingSystem.scgj.server;
...
@Configuration
@ComponentScan(basePackages={"com.postManagementTrackingSystem.scgj"})
...
public class Application 
{
    ...
    private static final String APPLICATION_PID = "/apps/postManagementTrackingSystem/application.pid"; 
